...
part 'vaccines_tab_lazy_load.g.dart';

@riverpod
class VaccinesTabLazyLoad extends _$VaccinesTabLazyLoad {
  ...
  Future<List<OrderModel>> _fetch() async {
    ...
    final result = await ref.read(orderRepositoryProvider).lazyFetchOrdersBy(
        _itemsPerBatch, _lastItem, 'Vaccine', ref.read(selectedPetIdProvider));
