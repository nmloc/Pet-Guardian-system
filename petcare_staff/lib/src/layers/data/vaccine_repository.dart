...
class VaccineRepository {
  ...
  Future<void> createVaccine(Vaccine vaccine) async => await queryVaccine()
      .add(vaccine)
      .then((docRef) => docRef.update({'id': docRef.id}));

  Future<Vaccine> fetch(String vaccineId) =>
  ...
  Future<(List<Vaccine>, DocumentSnapshot?)> lazyFetchVaccines(
